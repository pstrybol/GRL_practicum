...
def test_getTrainTestData(karate_club):
    ...
    X_train, X_test, Y_train, Y_test = karate_club.getTrainTestData(neg_pos_ratio=5,
                                                                    method='ms_tree',
                                                                    train_ratio=0.7,
    ...
    # With validation set
    X_train, X_val, X_test, Y_train, Y_val, Y_test = karate_club.getTrainTestData(neg_pos_ratio=5,
                                                                                  method='ms_tree',
                                                                                  train_ratio=0.7,
...
def test_filter_graph_by_LP(karate_club, dl_net_karate, karate_net_training_test):
    visualize = False
    np.random.seed(42)
